...
//       ],
//     }),
//     [labels, datasetA, datasetB, countryA, countryB, metricLabel, colors]
//   );
//
...
export default function ComparisonChart({
  ...
  const exportCsv = () => {
    const rows = [
      ["Year", `${countryA} - ${metricLabel}`, `${countryB} - ${metricLabel}`],
